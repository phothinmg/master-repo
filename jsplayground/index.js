...
!(function (e, t) {
  ...
  function He(e, t, n) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && "before" == n ? (r = i) : (We = i)),
        o.from == t && (o.from != o.to && "before" != n ? (r = i) : (We = i));
    }
    return null != r ? r : We;
  }
  (Fe = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/),
    ...
    Re = function (e, t) {
        ...
        if (ze.test(o[D])) {
          ...
          for (var P = W; P < D; )
            if (Ie.test(o[P])) {
              ...
              var z = P;
              for (++P; P < D && Ie.test(o[P]); ++P);
              A.splice(H, 0, new Be(2, z, P)), (H += F), (W = P);
            } else ++P;
      ...
      return (
        "ltr" == t &&
          (1 == A[0].level &&
            (O = e.match(/^\s+/)) &&
            ((A[0].from = O[0].length), A.unshift(new Be(0, 0, O[0].length))),
          1 == I(A).level &&
            (O = e.match(/\s+$/)) &&
            ((I(A).to -= O[0].length), A.push(new Be(0, i - O[0].length, i)))),
        "rtl" == t ? A.reverse() : A
      );
    };
  function Be(e, t, n) {
  ...
  var Ue = [],
    k = function (e, t, n) {
      e.addEventListener
        ...
        : ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || Ue).concat(n));
    };
  function Ve(e, t) {
  ...
  function st(e) {
    if ("string" == typeof e && lt.hasOwnProperty(e)) e = lt[e];
      ...
      var t = lt[e.name];
      (e = Se((t = "string" == typeof t ? { name: t } : t), e)).name = t.name;
    } else {
  ...
  function At(n, r, e) {
    ...
    var o = (function (e, t, n) {
        for (
          ...
          if (
            u &&
            (!n || s + (u instanceof Tt ? u.lookAhead : 0) <= o.modeFrontier)
          )
            return s;
  ...
  function Wt(e, t) {
    ...
    if (e.innerMode)
      return (
        (e = dt(e, t)), e.mode.blankLine ? e.mode.blankLine(e.state) : void 0
      );
  }
  function Ht(e, t, n, r) {
    for (var i = 0; i < 10; i++) {
      ...
      var d,
        f =
          c.pos > e.options.maxHighlightLength
            ? ((s = !1), l && Dt(e, t, r, c.pos), (c.pos = t.length), null)
  ...
  function Ut(e, t) {
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            (!(
              ...
              (r = r || []).push(new Bt(s, l.from, o ? null : l.to)));
          }
        return r;
      })(n, r, o),
      s = (function (e, t, n) {
          ...
          for (var i = 0; i < e.length; ++i) {
            ...
            (!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) &&
              ...
              ((o =
                null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)),
              (r = r || []).push(
                new Bt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)
              ));
          }
        return r;
      })(e, i, o),
      a = 1 == t.text.length,
      u = I(t.text).length + (a ? r : 0);
    if (l)
    ...
    if (s)
      for (var f = 0; f < s.length; ++f) {
        ...
        null != p.to && (p.to += u),
          null == p.from
            ? Gt(l, p.marker) || ((p.from = u), a && (l = l || []).push(p))
            ...
            (function e(t, n, r) {
              {
                ...
                if (null == r.to)
                  return (
                    (i = r.marker.find(1, !0)),
                    e(t, i.line, Gt(i.line.markedSpans, r.marker))
                  );
              }
      ...
      var o = i ? t.rest[i - 1] : t.line,
        ...
        l =
          ...
          (function (e) {
            ...
            return (
              te(e), n && n.left != n.right && (Je = t.right - n.right < 3)
            );
          })(e.display.measure) &&
      ...
      !(function (e, t, n) {
        ...
        if (r)
          ...
          for (var O = 1; O < n.length; O += 2)
            t.addToken(t, i.slice(o, (o = n[O])), cn(n[O + 1], t.cm.options));
      })(o, r, Ot(e, o, l)),
        o.styleClasses &&
        ...
        for (var c = document.createDocumentFragment(), h = 0; ; ) {
          ...
          "\t" == d[0]
            ? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
              (p = c.appendChild(M("span", we(f), "cm-tab"))).setAttribute(
                "role",
                "presentation"
              ),
  ...
  function gn(e, t, n) {
    (this.line = t),
      ...
      (this.size = this.rest ? H(I(this.rest)) - n + 1 : 1),
      ...
      if ("text" == o) {
        ...
        s.text == s.node && (s.node = u.pre),
          ...
          u.bgClass != s.bgClass || u.textClass != s.textClass
            ? ((s.bgClass = u.bgClass), (s.textClass = u.textClass), Sn(l, s))
  ...
  function In(e, t) {
    var n,
      ...
      e =
        (o && !o.text
          ? (o = null)
          : o && o.changes && (wn(e, o, i, ur(e)), (e.curOp.forceUpdate = !0)),
        o ||
          ((e = e),
          (r = H((n = Jt((n = t))))),
          ((n = e.display.externalMeasured = new gn(e.doc, n, r)).lineN = r),
          (r = n.built = hn(e, n)),
          (n.text = r.pre),
  ...
  function tr(e, t, n) {
    ...
    for (var l = W(r, i); ; ) {
      var s = (function (n, e, t, r, i) {
          ...
          c &&
            ((c = (n.options.lineWrapping ? lr : or)(n, e, t, o, c, r, i)),
            (u = 1 != c.level),
            (s = u ? c.from : c.to - 1),
            (a = u ? c.to : c.from - 1));
          var h = null,
  ...
  function rr(e, t, n, r) {
    return nr(e, t, (n = n || In(e, t)), _n(e, t, Rn(e, n, r), "line").top);
  }
  function ir(e, t, n, r) {
  ...
  function sr(e) {
    ...
    if (null == Bn) {
      ...
      for (var t = 0; t < 49; ++t)
        Bn.appendChild(document.createTextNode("x")), Bn.appendChild(M("br"));
  ...
  function fr(e, t, n, r) {
    ...
    return (
      r &&
        ...
        (i = F(
          i.line,
          Math.max(0, Math.round((o - Dn(e.display).left) / ar(e.display)) - n)
        ))),
      i
    );
  }
  ...
  function wr(e, t) {
    ...
    for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
      (!t && c == n.sel.primIndex) ||
        ...
        l
          ? (u = l(e, s)) && xr(e, u, i)
          : (a || e.options.showCursorWhenSelecting) && xr(e, s.head, i),
        a ||
          (function (i, e, t) {
            var n = i.display,
              o = i.doc,
    ...
    (e.state.delayingBlurEvent = !0),
      setTimeout(function () {
        e.state.delayingBlurEvent &&
          ((e.state.delayingBlurEvent = !1), e.state.focused && Mr(e));
      }, 100);
  }
  function Tr(e, t) {
    e.state.delayingBlurEvent &&
    ...
    for (
      ...
      if (!s.hidden) {
        ...
        c > e.display.sizerWidth &&
          (a = Math.ceil(c / ar(e.display))) > e.display.maxLineLength &&
      ...
      n &&
        ...
        r < i
          ...
          : Math.min(n, t.lastLine()) >= o &&
            ((i = vt(t, rn(W(t, n)) - e.wrapper.clientHeight)), (o = n))),
  ...
  function Dr(e, t) {
    var n = e.display,
      ...
      l = {},
      s =
        (t.bottom - t.top > o && (t.bottom = t.top + o), e.doc.height + An(n)),
      a = t.top < r,
      r = t.bottom > s - r,
      r =
        (t.top < i
  ...
  function zr(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (d || ti(e, { top: t }), Ir(e, t, !0), d && ti(e), qr(e, 100));
  }
  function Ir(e, t, n) {
    (t = Math.max(
      0,
    ...
    if (e) {
      var t = function (e) {
        ...
        for (var u = 0; u < n.length; u++) {
          ...
          (c.barMeasure = Br(h)),
            d.maxLineChanged &&
              ...
              ((c.adjustWidthTo =
                En(h, d.maxLine, d.maxLine.text.length).left + 3),
        ...
        for (var v, y = 0; y < n.length; y++) {
          ...
          null != b.scrollTop && Ir(w, b.scrollTop, b.forceScroll);
          ...
          b.scrollToPos &&
            ...
            (function (e, t) {
              ...
              A(e, "scrollCursorIntoView") ||
                ((o = (n = e.display).sizer.getBoundingClientRect()),
                (r = null),
                ...
                t.top + o.top < 0
                  ...
                  : t.bottom + o.top >
                      (i.defaultView.innerHeight ||
                        i.documentElement.clientHeight) && (r = !1),
                null == r ||
                  X ||
                  ((o = M(
                    "div",
                    ...
                    null,
                    "position: absolute;\n                         top: " +
                      (t.top - n.viewOffset - On(e.display)) +
                      "px;\n                         height: " +
      ...
      c.iter(
        ...
        function (e) {
          if (a.line >= l.display.viewFrom) {
            ...
            e.text.length <= l.options.maxHighlightLength && Dt(l, e.text, a),
        ...
        o <= c.viewFrom
          ...
          : (c.viewFrom > i
            ...
            c.viewTo < o
              ...
              : c.viewTo > o && (c.view = c.view.slice(0, pr(l, o)))),
        (c.viewTo = o),
    ...
    for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
      ...
      if (!y.hidden)
        if (y.node && y.node.parentNode == d) {
          ...
          y.changes &&
            (-1 < L(y.changes, "gutter") && (b = !1), wn(s, y, m, u)),
            b &&
              (te(y.lineNumber),
    ...
    return (
      ...
      (o = l) &&
        ...
        !/^(INPUT|TEXTAREA)$/.test(o.activeElt.nodeName) &&
          ...
          ((i = (c = o.activeElt.ownerDocument).defaultView.getSelection()),
  ...
  function ei(e, t) {
    for (var n = t.viewport, r = !0; ; r = !1) {
      if (r && e.options.lineWrapping && t.oldDisplayWidth != Hn(e))
        ...
        (n &&
          null != n.top &&
          (n = { top: Math.min(e.doc.height + An(e.display) - Fn(e), n.top) }),
  ...
  function ti(e, t) {
    var n,
      t = new Qr(e, t);
    Jr(e, t) &&
      (Nr(e), ei(e, t), (n = Br(e)), br(e), Vr(e, n), ri(e, n), t.finish());
  }
  function ni(e) {
  ...
  function ui(e, t, n, r) {
    ...
    (i.mover = M("div", [o], null, "position: relative")),
      ...
      m && 105 <= V && (i.wrapper.style.clipPath = "inset(0px)"),
  ...
  function pi(e, t) {
    ...
    if ((r && s) || (n && a)) {
      ...
      if (r && !d && !K && null != i)
        return (
          n && a && zr(e, Math.max(0, l.scrollTop + n * i)),
    ...
    G =
      ...
      (B.prototype.deepCopy = function () {
        for (var e = [], t = 0; t < this.ranges.length; t++)
          e[t] = new G(xt(this.ranges[t].anchor), xt(this.ranges[t].head));
  ...
  function vi(e) {
    return e.text
      ? F(
          ...
          I(e.text).length + (1 == e.text.length ? e.from.ch : 0)
        )
      : e.to;
  }
  function yi(e, t) {
  ...
  function Li(e, o, t, l) {
    ...
    o.full
      ...
      ? 1 == c.length
        ...
        : ((s = r(1, c.length - 1)).push(new sn(f + h.text.slice(u.ch), p, l)),
  ...
  function Ri(e, t, n, r, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      U(e, new B([Ii(e.sel.primary(), t, n, i)], 0), r);
  }
  function Bi(e, t, n) {
    for (
      ...
      r[o] = Ii(e.sel.ranges[o], t[o], null, i);
    ...
    (je(e, "beforeSelectionChange") ||
      ...
      (o = {
        ...
        update: function (e) {
          this.ranges = [];
          for (var t = 0; t < e.length; t++)
            this.ranges[t] = new G(E(r, e[t].anchor), E(r, e[t].head));
        },
        origin: o && o.origin,
      }),
      O(r, "beforeSelectionChange", r, o),
      r.cm && O(r.cm, "beforeSelectionChange", r.cm, o),
      (t = o.ranges != i.ranges ? gi(r.cm, o.ranges, o.ranges.length - 1) : i));
    var r,
      i,
      o =
        (n && n.bias) ||
        ...
        if (
          ...
          if (a.atomic) {
            if (n) {
              ...
              if (
                (s = (r < 0 ? c : u)
                  ? qi(e, s, -r, s && s.line == t.line ? o : null)
                  : s) &&
                s.line == t.line &&
                (h = P(s, n)) &&
                (r < 0 ? h < 0 : 0 < h)
  ...
  function eo(e, n) {
    ...
    (1 == n.text.length && "" == n.text[0] && 0 == P(n.from, n.to)) ||
      ...
      (r = []),
      ki(e, function (e, t) {
        t || -1 != L(r, e.history) || (so(e.history, n), r.push(e.history)),
          ro(e, n, null, Ut(e, n));
      }));
  }
  function to(i, o, e) {
        ...
        for (
          var c = [],
            h =
              ...
              je(i, "beforeChange") || (i.cm && je(i.cm, "beforeChange"))),
          ...
          var f = (function (e) {
            ...
            var t = e ? bi(i, n) : I(s),
              r =
                (ro(i, n, t, Ei(i, n)),
                !e && i.cm && i.cm.scrollIntoView({ from: n.from, to: vi(n) }),
                []);
            ki(i, function (e, t) {
              t ||
                -1 != L(r, e.history) ||
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++)
          oo(o.ranges[s].anchor, t, n, r), oo(o.ranges[s].head, t, n, r);
      } else {
  ...
  (G.prototype.from = function () {
    ...
    (co.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        this.size - t < 25 &&
          (1 < this.children.length || !(this.children[0] instanceof uo)) &&
          (this.collapse((n = [])),
      ...
      maybeSpill: function () {
        if (!(this.children.length <= 10)) {
          ...
          do {
            var t,
              n = new co(e.children.splice(e.children.length - 5, 5));
          } while (
            (e.parent
              ? ((e.size -= n.size),
                (e.height -= n.height),
              ...
              : ((((t = new co(e.children)).parent = e).children = [t, n]),
                (e = t)),
            (n.parent = e.parent),
  ...
  function mo(r, i, o, e, t) {
    ...
    d.addToHistory && Di(r, { from: i, to: o, origin: "markText" }, r.sel, NaN);
    var p,
      g = i.line,
      m = r.cm;
    if (
      (r.iter(g, o.line + 1, function (e) {
        ...
        m &&
          ...
          (e = e),
          (t = new Bt(d, g == i.line ? i.ch : null, g == o.line ? o.ch : null)),
          (n =
            (n = r.cm && r.cm.curOp) &&
            window.WeakSet &&
  ...
  (po.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      null != r && t && this.collapsed && z(t, r, i + 1),
        (this.lines.length = 0),
      ...
      r &&
        ...
        h(o, function () {
          var e = r.line,
            t = H(r.line),
            t = zn(o, t);
          t && (Vn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
      ...
      (((f.prototype = Se(co.prototype, {
        ...
        getSelection: function (e) {
          for (var t = this.sel.ranges, n = 0; n < t.length; n++)
            var r = pt(this, t[n].from(), t[n].to()), i = i ? i.concat(r) : r;
                ...
                (function (e, t, n) {
                  for (
                    ...
                    var l = t[o],
                      ...
                      i = a;
                    "around" == n
                      ? ((l = P((l = e.sel.ranges[o]).head, l.anchor) < 0),
        ...
        setHistory: function (e) {
          ...
          (t.done = zi(e.done.slice(0), null, !0)),
            (t.undone = zi(e.undone.slice(0), null, !0));
        },
            ...
            e.gutterMarkers &&
              ...
              ao(n, e, "gutter", function () {
                return (
                  ...
                  Me(e.gutterMarkers) && (e.gutterMarkers = null),
                  1
                );
              });
          });
        ...
        unlinkDoc: function (e) {
          ...
          e.history == this.history &&
            ...
            (e.history.done = zi(this.history.done, r)),
            (e.history.undone = zi(this.history.undone, r)));
        },
            ...
            if (c) {
              if (
                ...
                for (var h = 0; h < u.length; ++h)
                  io(r.doc, "", u[h].anchor, u[h].head, "drag");
  ...
  function Io(e, t) {
    ...
    return (
      null != n &&
      !e.altGraphKey &&
      zo((n = 3 == e.keyCode && e.code ? e.code : n), e, t)
    );
  }
  function Ro(e) {
  ...
  function Bo(t, e) {
    for (var n = t.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
      for (var o = e(n[i]); r.length && P(o.from, I(r).to) <= 0; ) {
        var l = r.pop();
            ...
            (1 == n
              ? t
                ? ((i = c),
                  ...
                  (l = r),
                  (s = e),
                  w ? setTimeout(ce(Lr, i), 0) : (i.curOp.focus = N(ae(i))),
                  (a = (function (e, t, n) {
                  ...
                  (i.options.dragDrop &&
                    ...
                    "single" == l &&
                    -1 < (l = u.contains(o)) &&
                    (P((l = u.ranges[l]).from(), o) < 0 || 0 < o.xRel) &&
                    (0 < P(l.to(), o) || o.xRel < 0)
                    ? function (t, n, r, i) {
                        var o = t.display,
                          l = !1,
                          s = R(t, function (e) {
                            x && (o.scroller.draggable = !1),
                              ...
                              l ||
                                (D(e),
                                i.addNew || Ri(t.doc, r, null, null, i.extend),
                                (x && !j) || (w && 9 == v)
                                  ? setTimeout(function () {
                    ...
                    : function (d, e, f, p) {
                        ...
                        "rectangle" == p.unit
                          ...
                          : ((e = sl(d, f, p.unit)),
                            (m = p.extend
                              ? Ii(m, e.anchor, e.head, p.extend)
                              : e));
                        p.addNew
                          ? -1 == v
                            ? ((v = t.length),
                              U(g, gi(d, t.concat([m]), v), {
                                scroll: !1,
                                origin: "*mouse",
                              }))
                            : 1 < t.length &&
                            ...
                            ? (U(
                                g,
                                gi(d, t.slice(0, v).concat(t.slice(v + 1)), 0),
                                { scroll: !1, origin: "*mouse" }
                              ),
                              (y = g.sel))
                            : Gi(g, v, m, me)
                          : (U(g, new B([m], (v = 0)), me), (y = g.sel));
                        var b = f;
                        function s(e) {
                          if (0 != P(b, e))
                            if (((b = e), "rectangle" == p.unit)) {
                              for (
                                ...
                                o == l
                                  ...
                                  : u.length > c &&
                                    t.push(new G(F(s, c), F(s, ye(u, l, n))));
                              }
                              t.length || t.push(new G(f, f)),
                                U(g, gi(d, y.ranges.slice(0, v).concat(t), v), {
                                  origin: "*mouse",
                                  scroll: !1,
                                }),
                                d.scrollIntoView(e);
                              ...
                              var h,
                                ...
                                e =
                                  0 < P(i.anchor, e)
                                    ? ((h = i.head), St(r.from(), i.anchor))
                                    : ((h = i.anchor), Ct(r.to(), i.head)),
                                r = y.ranges.slice(0);
                              (r[v] = (function (e, t) {
                                var n = t.anchor,
                                  r = t.head,
                                  i = W(e.doc, n.line);
                                if (0 == P(n, r) && n.sticky == r.sticky)
                                  return t;
                                i = Ge(i);
                                if (!i) return t;
              ...
              : 3 == n && (Q ? c.display.input.onContextMenu(e) : kr(c)))));
  }
  function sl(e, t, n) {
  ...
  function al(e, t, n, r) {
    ...
    for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
      ...
      if (a && a.getBoundingClientRect().right >= i)
        return (
          O(e, n, e, vt(e.doc, o), e.display.gutterSpecs[s].className, t), $e(t)
        );
    }
  }
  function ul(e, t) {
  ...
  function cl(e, t) {
    ...
    Nn(e.display, t) ||
      ((r = t),
      je((n = e), "gutterContextMenu") && al(n, r, "gutterContextMenu", !1)) ||
      A(e, t, "contextmenu") ||
      Q ||
        ...
        w && v < 11
          ? R(l, function (e) {
              ...
              A(l, e) ||
                ...
                ul(l, e) ||
                Nn(l.display, e) ||
                (D(e), (e = l.findWordAt(t)), Ri(l.doc, e.anchor, e.head));
            })
          : function (e) {
              return A(l, e) || D(e);
            }
  ...
  function yl(e, t, n, r) {
    ...
    if ((d < c && (h += we(c - d)), h != u))
      return (
        io(o, h, F(t, 0), F(t, u.length), "+input"), !(s.stateAfter = null)
      );
        ...
        f =
          (f.empty() &&
            (n && 0 < n
              ...
              ? (g = F(
                  g.line,
                  Math.min(W(o, g.line).text.length, g.ch + I(a).length)
                ))
              : s &&
                bl &&
                bl.lineWise &&
      ...
      if (o.node == r) {
        ...
        if (o == s)
          if (((a = !0), (o = s.childNodes[l]), (l = 0), !o))
            return Al(
              F(H((c = u.rest ? I(u.rest) : u.line)), c.text.length),
              a
            );
  ...
  (r.prototype.init = function (e) {
    ...
    (r.prototype.focus = function () {
      "nocursor" != this.cm.options.readOnly &&
        ((this.selectionInEditor() && N(this.div.ownerDocument) == this.div) ||
    ...
    (r.prototype.pollContent = function () {
      ...
      (r = F(e, u)), (l = F(o, a.length ? I(a).length - c : 0));
  ...
  (i.prototype.init = function (n) {
    ...
    (i.prototype.createField = function (e) {
      ...
      kl(this.textarea, t.spellcheck, t.autocorrect, t.autocapitalize);
    }),
    ...
    (Fl.prototype = {
      ...
      addOverlay: t(function (e, t) {
        ...
        for (
          ...
          o++;
        r.splice(o, 0, n), this.state.modeGen++, z(this);
      }),
      removeOverlay: t(function (e) {
        for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
          var r = t[n].modeSpec;
          if (r == e || ("string" == typeof e && r.name == e))
            return t.splice(n, 1), this.state.modeGen++, void z(this);
        }
      }),
      ...
      addWidget: function (e, t, n, r, i) {
        ...
        (t.style.position = "absolute"),
          ...
          n &&
            ...
            null != (l = Dr(r, l)).scrollTop && zr(r, l.scrollTop),
      ...
      findPosH: function (e, t, n, r) {
        for (
          var i = 1, o = (t < 0 && ((i = -1), (t = -t)), E(this.doc, e)), l = 0;
    ...
    (Fl.registerHelper = function (e, t, n) {
      El.hasOwnProperty(e) || (El[e] = Fl[e] = { _global: [] }), (El[e][t] = n);
    }),
    (Fl.registerGlobalHelper = function (e, t, n, r) {
      Fl.registerHelper(e, t, r), El[e]._global.push({ pred: n, val: r });
    });
  var zl,
    Il = "iter insert remove copy getEditor constructor".split(" ");
  for (zl in f.prototype)
    f.prototype.hasOwnProperty(zl) &&
      L(Il, zl) < 0 &&
      (p.prototype[zl] = (function (e) {
        return function () {
...
//https://www.npmjs.com/package/@ui-js/code-playground   
...
var mark = function (root, language, arg) {
  var _a;
...
var echo = function (rest, tty, finalize, output) {
...
var randomJavaScriptId = function () {
  return (
...
var asString = function (depth, value, options = {}) {
  var _a, _b;
  (_a = options.quote) !== null && _a !== void 0 ? _a : (options.quote = '"');
  (_b = options.ancestors) !== null && _b !== void 0
    ? _b
    : (options.ancestors = []);
  //
  // BOOLEAN
...
var YELLOW = base0a;
// ===
var DEFAULT_AUTORUN_DELAY = 1000;
...
.cm-s-tomorrow-night span.cm-bracket { color: var(--_base-06); }
...
class CodePlayground extends HTMLElement {
  constructor() {
    ...
    this.timers = {};
    this.moduleMap =
      (_a = window["moduleMap"]) !== null && _a !== void 0 ? _a : {};
    this.attachShadow({ mode: "open", delegatesFocus: true });
  }
  static get observedAttributes() {
    return Object.values(CodePlayground.attributes);
  }
  get showLineNumbers() {
    return (
  ...
  get buttonBarVisibility() {
    ...
    const val =
      (_b =
        (_a = this.getAttribute("button-bar-visibility")) !== null &&
        _a !== void 0
          ? _a
          : this.getAttribute("buttonBarVisibility")) !== null && _b !== void 0
        ? _b
        : "auto";
    if (val === "auto") {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    const attributes = CodePlayground.attributes;
    if (
      ...
      this.shadowRoot
        ...
        .forEach((x) => {
          var _a;
          return (_a =
            x === null || x === void 0 ? void 0 : x["CodeMirror"]) === null ||
            _a === void 0
            ? void 0
            : _a.setLineNumbers(this.showLineNumbers);
        });
    }
  }
  ...
  updateButtonBar() {
    ...
    runButton === null || runButton === void 0
      ? void 0
      : runButton.classList.toggle("visible", this.autorun === "never");
    buttonBar === null || buttonBar === void 0
      ? void 0
      : buttonBar.classList.toggle(
          "visible",
          buttonBarVisibility === "visible"
        );
  }
  connectedCallback() {
    ...
    <div inert class="original-content" translate="no">
    <slot name="html"></slot><slot name="javascript"></slot>
    </div>
    <div class="__code-playground-container" translate="no">
       ...
       <div class="__code-playground-button-bar" part="button-bar">
            <button id="reset-button" part="button" disabled>
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="history" class="svg-inline--fa fa-history fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <button id="run-button" part="button">
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="play" class="svg-inline--fa fa-play fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    this.resizeObserver = new ResizeObserver(() => {
      requestAnimationFrame(() => {
        shadowRoot.querySelectorAll("textarea + .CodeMirror").forEach((x) => {
          var _a;
          return (_a =
            x === null || x === void 0 ? void 0 : x["CodeMirror"]) === null ||
            _a === void 0
  ...
  update() {
    ...
    if ("CodeMirror" in window && window.CodeMirror !== undefined) {
      ...
      shadowRoot.querySelectorAll(".editors textarea").forEach((x) => {
        var _a;
        ...
        const lang =
          ...
          }[x.dataset.language]) !== null && _a !== void 0
            ? _a
            : "javascript";
  ...
  async run() {
    ...
    if (htmlEditor) {
      htmlContent =
        (_a = htmlEditor["CodeMirror"]) === null || _a === void 0
          ? void 0
          : _a.getValue();
    } else {
      htmlContent =
        (_c =
          (_b = shadowRoot.querySelector('textarea[data-language="html"]')) ===
            null || _b === void 0
            ? void 0
    ...
    scriptTags === null || scriptTags === void 0
      ? void 0
    ...
    if (jsEditor) {
      jsContent =
        (_d = jsEditor["CodeMirror"]) === null || _d === void 0
          ? void 0
          : _d.getValue();
    } else {
      jsContent =
        (_f =
          (_e = shadowRoot.querySelector(
    ...
    window.onerror = (msg, url, line, _colno, error) => {
      if (url === window.location.href) {
        if (line === 0) {
          if (
            typeof (error === null || error === void 0
              ? void 0
  ...
  reset() {
    ...
    slots.forEach((slot) => {
      ...
      if (text) {
        ...
        if (editor) {
          (_a = editor["CodeMirror"]) === null || _a === void 0
            ? void 0
            : _a.setValue(sanitizeInput(text));
  ...
  get pseudoConsole() {
    ...
    const appendConsole = (msg, cls) => {
      ...
      let lines =
        (_b =
          (_a = this.consoleContent) === null || _a === void 0
            ? void 0
            : _a.split("\n")) !== null && _b !== void 0
          ? _b
          : [];
      ...
      echo(
        ...
        (s) => {
          ...
          that.consoleContent =
            ...
            lines.join("\n") +
            "&nbsp;&nbsp;".repeat(
              (_a = parseInt(console.dataset["group-level"])) !== null &&
                _a !== void 0
                ? _a
                : 0
            ) +
